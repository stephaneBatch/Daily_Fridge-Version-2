 ...
 */
final class Version20200229164549 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_50894E3D89312FE9 ON compo_recette (recette_id)');
        $this->addSql('CREATE INDEX IDX_50894E3DF347EFB ON compo_recette (produit_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_50894E3D89312FE9 ON compo_recette');
        $this->addSql('DROP INDEX IDX_50894E3DF347EFB ON compo_recette');
